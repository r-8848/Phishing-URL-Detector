...
# ### 1: Domain of the URL
# Here, we are  extracting the domain present in the URL. e
    ...
    try:
        ...
        if expiration_date is None:
            ...
            if expiration_date.tzinfo is not None:
                expiration_date = expiration_date.replace(tzinfo=None)  # Make the expiration_date naive
            ...
            return 1
    except (whois.parser.PywhoisError, socket.gaierror, socket.timeout, ConnectionResetError):
        # Handle specific errors related to WHOIS queries and network issues
        return 1
    except Exception as e:
        # Log the exception if needed, e.g., print(f"Unexpected error: {e}")
        return 1
